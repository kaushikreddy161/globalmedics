...
import IconHydration from "../assets/icon-hydration.png";
import IconMedicine from "../assets/icon-medicine.png";
...
async function facebookPIC(fuserid,access_token){
 ...
 // let userInfo = await axios.get(`https://graph.facebook.com/me?fields=name,gender,location,picture&access_token=${access_token}`, 
  ...
  else if (props.rimg == "rtn") {
    rimg = IconTiredness;
  }
  else if (props.rimg == "hdr") {
    rimg = IconHydration;
  }
  else if (props.rimg == "mdc") {
    rimg = IconMedicine;
  }
  else if (props.rimg == "ntc") {
    rimg = IconNutrition;
  }
