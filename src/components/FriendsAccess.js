...
const FriendAndNeighboursAccess = () => {
        ...
        <div className="form-d">
          ...
          >
            <Card.Body>
              ...
              <p style={{ marginTop: "1rem", marginBottom: "2rem", color: "#ADAAA7" }}>These people are requesting access to support {pname} as "Family Members". Please accept their</p>
              <div class="container">
                <div
...
export default FriendAndNeighboursAccess;