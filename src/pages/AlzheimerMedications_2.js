...
import IconalzheMedications from "../assets/icon-alzhe-medi.png";
...
const DiabetesMedications_2 = () => {
  ...
  const onSubmit = () => {
    const path = `/alzheimerMedications_3`;
    navigate(path);
  };
                      ...
                      <div class="container">
                        ...
                        >
                          <div class="row align-items-center m-space">
                            <div class="col-2">
                              <img src={IconalzheMedications} />
                            </div>
                            <div class="col-8 dark-green">
                            Medications for Alzheimer’s / Dementia Diseases
                            </div>
...
export default DiabetesMedications_2;
