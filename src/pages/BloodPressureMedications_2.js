...
import IconBSMedications from "../assets/icon-select-vit-bprs.png";
...
const BloodPressureMedications_2 = () => {
  ...
  const onSubmit = () => {
    const path = `/bloodPressureMedications_3`;
    navigate(path);
  };
...
export default BloodPressureMedications_2;
