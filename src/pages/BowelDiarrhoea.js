...
import IconMotionSmall from "../assets/icon_motion_small.png";
import IconMotionMedium from "../assets/icon_motion_medium.png";
import IconMotionLarge from "../assets/icon_motion_large.png";
import IconMotionSmallS from "../assets/icon_motion_small_sel.png";
import IconMotionMediumS from "../assets/icon_motion_medium_sel.png";
import IconMotionLargeS from "../assets/icon_motion_large_sel.png";
...
const BowelDiarrhoea = () => {
  ...
  const [list1, setList1] = useState([
    { name: "Small", icon: IconMotionSmall, value: "1" },
    { name: "Medium", icon: IconMotionMedium, value: "2" },
    { name: "Large", icon: IconMotionLarge, value: "3" },
  ]);
  ...
  const List1ChangeImage = (val, id) => {
    ...
    if (val.value == 1) {
      list1[0].icon = IconMotionSmallS;
      list1[1].icon = IconMotionMedium;
      list1[2].icon = IconMotionLarge;
      setList1([...list1]);
    }
    if (val.value == 2) {
      list1[0].icon = IconMotionSmall;
      list1[1].icon = IconMotionMediumS;
      list1[2].icon = IconMotionLarge;
      setList1([...list1]);
    }
    if (val.value == 3) {
  ...
  const onSubmit = async (event) => {
    ...
    try {
      if (user) {
        ...
        let cid = adbuser;
      //  let pid = pId;
        const createx = user.functions.createSymptomsBDiarrhoea(
          id,
          "GlobalMedics2021",
          ...
          >
            <Card.Body>
              ...
              <div className="container">
                ...
                >
                  What Is The Quantity Of The Motion
                </p>
              ...
              <div className="container">
                <div class="row">
                  ...
                  >
                    Is there fresh or altered blood in/after the motion
                  </div>
                  <div class="col-2">
                    <img src={DiarrhoeaMotion} />
                  </div>
                </div>
              ...
              <div className="container">
                ...
                >
                  Is there Mucus with/after the motion
                </p>
                <div className="form-container">
                  <Box sx={{ flexGrow: 1 }}>
                    <Grid
              ...
              <div className="container">
                <div class="row">
                  ...
                  >
                    Is it associated (preceded/accompanied) with griping pain in
                    abdomen?
                  </div>
                  <div class="col-2">
                    <img src={DiarrhoeaPre} />
                  </div>
                </div>
                <div className="form-container">
                  <Box sx={{ flexGrow: 1 }}>
