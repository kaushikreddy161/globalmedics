    ...
    if (datey === "" || breaths === "") {
      ...
      try {
        if (user) {
          ...
          // let pid = selLid;
          let pid = pId;
          const createx = user.functions.createRespRate(
            id,
            cypherData(breaths),
            datey,
            cid,
         ...
         //   console.log("resp:", resp);
            alert("Breathing Rate Record Added Successfully");
            navigate(`/vitals`);
          });
        }
      } catch (error) {
    ...
    <Container style={{ background: "#EBEBEB", maxWidth: "100%" }}>
      ...
      >
        <FixedHeader
          ...
          title2="Count number of breaths per minute"
