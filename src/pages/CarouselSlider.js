           ...
           {lovedones.map((item) => (
            ...
            >
              ...
              >
                ...
                >
                  <img
                    src={(fgpicture !== "" && item.patientId === adbuser) ? fgpicture : faceIcon}
                    role="presentation"
                ...
                <div style={{ textAlign: "center", color: "#707070" }}>
                  {item.patientId === adbuser ? "Self" : item.displayName}
                </div>
                <div style={{ height: "5px" }}></div>
              </Card>
            </div>
           ...
           {lovedones.map((item) => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <img
                        src={(fgpicture !== "" && adbuser === item.patientId) ? fgpicture : faceIcon}
                        role="presentation"
                    ...
                    <div style={{ height: "10px" }}></div>
                    <div style={{ textAlign: "center", color: "#707070" }}>
                       {(adbuser == item.patientId) ? "Self" : (item.displayName)}
                    </div>
                    <div style={{ height: "5px" }}></div>
                  </Card>
                </div>
