                    ...
                    <Form.Group>
                      ...
                      >
                        <Card.Body style={{ marginBottom: "-1rem" }}>
                          ...
                          <br />
                          <>
                            <select className="form-control" style={{ color: "#ADAAA7" }}>
                        ...
                        <Card.Body>
                          ...
                          <div className="mt-2">
                            <div class="form-check form-check-inline">
                              ...
                              <label class="form-check-label text-gray1" for="inlineRadio1">Remote</label>
                            </div>
                            <div class="form-check form-check-inline">
                              <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2" style={{textAlign:"right"}}/>
                              <label class="form-check-label text-gray1" for="inlineRadio2">Physical</label>
                            </div>
                          </div>
                        </Card.Body>
                      </Card>
