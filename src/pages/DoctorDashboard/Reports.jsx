          ...
          <div className="col-3">
            <div className="card card-height">
              <div className="card-body">
                ...
                <p className='card-text'>a. X-Ray</p>
                <p className='card-text-file'>Filename / Date of Report</p>
                <p className='card-text-file'>Filename / Date of Report</p>

                <p className='card-text'>b. Ultrasound</p>
                <p className='card-text-file'>Filename / Date of Report</p>
                <p className='card-text-file'>Filename / Date of Report</p>

                <p className='card-text'>c. CT</p>
                <p className='card-text-file'>Filename / Date of Report</p>
                <p className='card-text-file'>Filename / Date of Report</p>



                <p className='card-text-top'>a. Blood</p>
                <p className='card-text-file'>Filename / Date of Report</p>
                <p className='card-text-file'>Filename / Date of Report</p>

                <p className='card-text'>b. Urine</p>
                <p className='card-text-file'>Filename / Date of Report</p>
                <p className='card-text-file'>Filename / Date of Report</p>

                <p className='card-text'>c. Stool</p>
                <p className='card-text-file'>Filename / Date of Report</p>
                <p className='card-text-file'>Filename / Date of Report</p>

                <p className='card-text'>d. Sputum</p>
                <p className='card-text-file'>Filename / Date of Report</p>
                <p className='card-text-file'>Filename / Date of Report</p>
