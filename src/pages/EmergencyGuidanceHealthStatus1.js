...
import IconCurrentStatus from "../assets/icon-patient-current-status.png";
import IconChiefComplaint from "../assets/icon-eg-chief-complaint.png";
import IconVitalSigns from "../assets/icon-eg-vital-signs.png";
...
const EmergencyGuidanceHealthStatus1 = () => {
  const { user, pId, pName, selectedPatient } = useContext(UserContext);
  const navigate = useNavigate();

  const onSubmit = () => {
    const path = `/EmergencyGuidanceHealthStatus2`;
    navigate(path);
  };
  ...
  const onDetailsChief = () => {
    const path = `/kindEmergency`;
    // const path = `/emergencyResponseAndPain`;
    navigate(path);
  };
            ...
            <Card.Body>
              {/* <div style={{ verticalAlign: "middle" }}> */}
                <div class="row align-items-center">
                  <div class="col-2"><img src={IconCurrentStatus} alt="" style={{ width: "70%" }} /></div>
                  <div class="col-10 text-green">Patient Current Status</div>
                </div>
              {/* </div> */}
              <div class="container">
                <div
              ...
              >
                <div class="container">
                  ...
                  >
                    <div class="col-2"><img src={IconChiefComplaint} className="image-header-size" /></div>
                    <div class="col-4 text-gray">Chief Complaint Registered</div>
                    ...
                    <div class="col-2" style={{ textAlign: "right", cursor: "pointer" }} onClick={onDetailsChief}>
              ...
              >
                <div class="container">
                  ...
                  >
                    <div class="col-2"><img src={IconVitalSigns} className="image-header-size" /></div>
                    <div class="col-4 text-gray">Vital Signs Recorded</div>
                    <div class="col-2" style={{ cursor: "pointer", textAlign: "center" }}>
                      {statusAccept2 ?
...
export default EmergencyGuidanceHealthStatus1;