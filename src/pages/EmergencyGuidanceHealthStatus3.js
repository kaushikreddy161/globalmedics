...
import IconCareRing from "../assets/icon-ec-care-ring.png";
import IconNextOfKin from "../assets/icon-ec-next-of-kin.png";
import IconLocalCare from "../assets/icon-ec-local-care.png";
import IconInsurance from "../assets/icon-ec-insurance.png";
import IconCash from "../assets/icon-ec-cash.png";
...
const EmergencyGuidanceHealthStatus2 = () => {
            ...
            <Card.Body>
              {/* <div style={{ verticalAlign: "middle" }}> */}
                <div class="row align-items-center">
                  <div class="col-2"><img src={IconCareRing} alt="" style={{ width: "70%" }} /></div>
                  <div class="col-10 text-green">Care Ring & Finance</div>
                </div>
              {/* </div> */}
              <div class="container">
                <div
              ...
              >
                <div class="container">
                  ...
                  >
                    <div class="col-2"><img src={IconNextOfKin} className="image-header-size" /></div>
                    <div class="col-4 text-gray">Next-of-kin Identified</div>
              ...
              >
                <div class="container">
                  ...
                  >
                    <div class="col-2"><img src={IconLocalCare} className="image-header-size" /></div>
                    <div class="col-4 text-gray">Local Care Giver Available</div>
                    <div class="col-2" style={{ cursor: "pointer", textAlign: "center" }}>
                      {statusAccept2 ?
              ...
              >
                <div class="container">
                  ...
                  >
                    <div class="col-2"><img src={IconInsurance} className="image-header-size" /></div>
                    <div class="col-4 text-gray">Insurance Details Uploaded</div>
                    <div class="col-2" style={{ cursor: "pointer", textAlign: "center" }}>
                      {statusAccept3 ?
              ...
              >
                <div class="container">
                  ...
                  >
                    <div class="col-2"><img src={IconCash} className="image-header-size" /></div>
                    <div class="col-4 text-gray">Cash Arranged</div>
                    <div class="col-2" style={{ cursor: "pointer", textAlign: "center" }}>
                      {statusAccept4 ?
...
export default EmergencyGuidanceHealthStatus2;