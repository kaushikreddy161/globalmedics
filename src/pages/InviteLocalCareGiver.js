...
const InviteLocalCareGiver = () => {
 ...
 //   event.preventDefault();
  ...
  const onInvite = (e) => {
    ...
    onConfirm(resOTP);
     //  var path = '\n\n https://globalmedicsb2c.b2clogin.com/globalmedicsb2c.onmicrosoft.com/oauth2/v2.0/authorize?p=B2C_1_signupsigningm&client_id=c61cd9bd-8e87-45fd-a8f2-f2ff2c7cc96b&nonce=defaultNonce&redirect_uri=http://localhost:3000&typ=caregiver&dpl='+cypherData(pId);  // local
    //  var path = '\n\n https://globalmedicsb2c.b2clogin.com/globalmedicsb2c.onmicrosoft.com/oauth2/v2.0/authorize?p=B2C_1_signInSignUpDev&client_id=32ddf657-01f9-4f6d-b3cc-21d0a295167f&nonce=defaultNonce&redirect_uri=https://globalmedicsdev.azurewebsites.net&typ=caregiver&dpl='+cypherData(pId);   // dev
...
export default InviteLocalCareGiver;
