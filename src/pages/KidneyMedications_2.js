...
import IconKidneyMedications from "../assets/icon-kidney-medi.png";
...
const KidneyMedications_2 = () => {
  ...
  const onSubmit = () => {
    const path = `/kidneyMedications_3`;
    navigate(path);
  };
              ...
              <div className="container">
                <div className="form-container">
                  ...
                  >
                    <div class="container">
                      <div class="row">
                        <div class="col-9">Set Medications for Parkinson’s Disease</div>
                        <div
                          class="col-3"
                      ...
                      <div class="container">
                        ...
                        >
                          ...
                          <div class="row align-items-center" style={{ marginTop: "0.5rem" }}>
                            ...
                            <div class="container">
                            <div className="medi-head">Dosage</div>
                              <div class="row align-items-center">

                                <div class="col-5 text-gray">Medicine amount per dose</div>
                              ...
                              {/* <div className="container"> */}
                              <div className="medi-head">Frequency</div>
                                <p
                                  style={{
                                    color: "#ADAAA7",
                                    marginTop: "0rem",
                                ...
                                >
                                  How often the medicine needs to be taken
                                </p>
                                <div className="form-container">
                                  <Box sx={{ flexGrow: 1 }}>
                                    <Grid
                              ...
                              <div class="row align-items-center">
                                <Divider className="hr-line" />
                                <div class="col-4 text-gray">Or, every</div>
                                <div class="col-3"><input
                                  type="number"
                                  class="form-control"
                                  name="bprFreq"
                                ...
                                <div class="col-5">
                                  ...
                                  // onChange={(e) => setbpUnits(e.target.value)}
                                  >
                                    <option value="">Hours / Days / Weeks</option>
                                  ...
                                  <div class="col-4 text-gray3">Before a Meal <input class="form-check-input" type="checkbox" value="" id="defaultCheck1" /></div>
                                  <div class="col-8 text-gray3">After a Meal <input class="form-check-input" type="checkbox" value="" id="defaultCheck2" /></div>
                               
                                <Divider className="hr-line" />
                              </div>
                              <div>Duration</div>
                              <div class="row align-items-center">
                                <div class="col-8 text-gray">Start taking medicine from this date</div>
                                <div class="col-4">
                                  <Form.Control
                                ...
                                <div class="col-8 text-gray">Take medicines till this date</div>
                                <div class="col-4">
                                  <Form.Control
                                    className="name-input"
                                    type="date"
...
export default KidneyMedications_2;
