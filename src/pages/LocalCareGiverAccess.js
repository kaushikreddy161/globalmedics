...
const LocalCareGiverAccess = () => {
 // gs const { user, pId, pName, selectedPatient } = useContext(UserContext);
  ...
  // const addMember = () => {
  //   const path = `/localCareGiversConsent`;
  //   navigate(path);
  // }
...
const loadUser = async () => {
  ...
  return (
    ...
    >
      ...
      >
        <FixedHeader
          title="Care Giver Access"
          title2="Please accept requests from people you are comfortable to support <<papa>> as <<Care Givers>>."
        ...
        <div className="form-d">
          ...
          >
            <Card.Body>
              ...
              <p style={{ marginTop: "1rem", marginBottom: "2rem", color: "#707070" }}>These people are requesting access to support {pname} as "Care Giver". Please accept their</p>
              <div class="container">
                <div
              ...
              >
                ...
                <div class="container">
                  ...
                  >
                    ...
                    <div class="col-3 text-green">Add New Member</div>
                    <div class="col-2">
                      {/* { statusDefault ?
...
export default LocalCareGiverAccess;