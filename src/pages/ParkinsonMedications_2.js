...
import IconParkinsMedications from "../assets/icon-parkins-medi.png";
...
const ParkinsonMedications_2 = () => {
  ...
  const onSubmit = () => {
    const path = `/parkinsonMedications_3`;
    navigate(path);
  };
                      ...
                      <div class="container">
                        ...
                        >
                          <div class="row align-items-center m-space">
                            <div class="col-2">
                              <img src={IconParkinsMedications} />
                            </div>
...
export default ParkinsonMedications_2;
