    ...
    >
      ...
      >
        <FixedHeader
          ...
          rimg="reg"
        />
        <div className="vr-line"><i class="arrow up"></i></div>
        <div className="overlay-comment">This Screen Header box gives brief description about the screen and who the details below are for.</div>
        <div className="car-overlay">
          <div className="car-ds-ts">
            <CarouselSlider />
          </div>
        </div>
...
export default TrainingScreen_1;