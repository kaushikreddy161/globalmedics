    ...
    >
      ...
      >
        <div className="car-overlay">
          ...
          <div className="vr-line1"><i class="arrow up"></i></div>
          <div className="overlay-comment1">Scroll through this box to select the loved one / patient. Or select “Self” for managing your own health. Image of selected person is displayed in the Heading Box on top.</div>
          <div className="car-overlay">
            <Card
              style={{
                marginTop: "0rem",
...
export default TrainingScreen_2;