  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="overlay-comment2">History of tasks previously performed by any care ring member, as recorded in the system.</div>
        <div className="vr-line3"><i class="arrow up"></i></div>
        <Card
          style={{
            marginTop: "0rem",
            marginBottom: "0rem",
...
export default TrainingScreen_4;