  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="overlay-comment3">Click on this Arrow to be taken to the screen for performing the suggested task.</div>
        <div className="vr-line4"><i class="arrow up"></i></div>
        <Card
          style={{
            marginTop: "0rem",
            marginBottom: "0rem",
...
export default TrainingScreen_5;