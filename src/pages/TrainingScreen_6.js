  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="overlay-comment4">Click on “i” button to open “Information” screen for contextual help pertaining to this section.</div>
        <div className="vr-line5"><i class="arrow up"></i></div>
        <Card
          style={{
            marginTop: "0rem",
            marginBottom: "0rem",
...
export default TrainingScreen_6;