              ...
              <div className="container">
                <div className="form-container">
                  ...
                  >
                    ...
                    <div class="row">
                      <div class="col-9">Verbal Responsiveness Check</div>
                      <div
                        class="col-3"
                    ...
                    <p className="info_para">Check if the person is fully awake, aware of their surroundings and has bodily motor function. They are able to follow commands and respond appropriately to questions like.</p>
                    <div className="margin-left">
                    <p className="info_para">1) Stick out your tongue.</p>
                      <p className="info_para">2) Close your eyes</p>
                      <p className="info_para">3) Press my hand</p>
                      <p className="info_para">4) What happened?</p>
                    </div>
...
export default VerbalResponsiveness;
